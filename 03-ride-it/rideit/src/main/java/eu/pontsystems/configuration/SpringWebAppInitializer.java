...
import eu.pontsystems.service.WebSecurityConfig;
...
public class SpringWebAppInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
	    ...
	    rootContext.register(RideItConfiguration.class, WebSecurityConfig.class, DriverPassengerLoginService.class);
