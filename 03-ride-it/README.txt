...
Important:
  If you sign in as driver Do Not Try to remove/add yourself to a car, so I recommend to log in always as passenger. This feature is 
  not implemented yet but is still under development.
